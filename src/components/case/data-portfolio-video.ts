...
export const PORTFOLIO_VIDEO_CASE: CaseData = {
  ...
  tagline: {
    en: "An AI-assisted audiovisual piece created to introduce my portfolio and translate my design identity into motion.",
    es: "Una pieza audiovisual asistida por IA creada para presentar mi portfolio y traducir mi identidad como diseñadora al movimiento.",
  },
  cover: {
    kind: "placeholder",
    label: {
      en: "01 - cover : portfolio video still / falling silhouette / 21:9",
      es: "01 - portada : still del portfolio video / silueta cayendo / 21:9",
    },
    tone: "paper",
    src: pvCover,
    alt: {
      en: "Portfolio video — falling silhouette still",
      es: "Portfolio video — still de silueta cayendo",
    },
  },
  meta: {
    role: {
      en: "Concept · Art Direction · AI-assisted Video Creation · Motion Editing",
      es: "Concepto · Dirección de arte · Creación de video con IA · Edición de motion",
    },
    period: "2026",
  ...
  intro: {
    context: {
      en: "This video was created as the audiovisual piece that accompanies my final portfolio website. It introduces the same concept behind the web: my identity as a designer is shaped by the processes, interests and ideas I have moved through.",
      es: "Este video se creó como la pieza audiovisual que acompaña mi sitio de portfolio final. Presenta el mismo concepto que la web: mi identidad como diseñadora está moldeada por los procesos, intereses e ideas por los que he pasado.",
    },
    problem: {
      en: "I wanted to create a piece that felt personal, delicate and emotional, while also working as a visual asset inside the scrolling experience of the website. The challenge was to use AI-generated video without losing authorship, intention or control over the final result.",
      es: "Quería crear una pieza que se sintiera personal, delicada y emotiva, y que a la vez funcionara como recurso visual dentro de la experiencia de scroll del sitio. El desafío era usar video generado por IA sin perder autoría, intención ni control sobre el resultado final.",
    },
    goal: {
      en: "Create a short portfolio video that could communicate my concept, represent my internal creative process and visually connect with the web experience.",
      es: "Crear un video corto de portfolio capaz de comunicar mi concepto, representar mi proceso creativo interno y conectar visualmente con la experiencia de la web.",
    },
    role: {
      en: "I developed the concept, wrote the visual script, designed the character and visual system, generated and curated AI video outputs, corrected frames manually in Procreate, edited the final piece in After Effects and produced the music direction using AI tools.",
      es: "Desarrollé el concepto, escribí el guion visual, diseñé el personaje y el sistema visual, generé y curé los resultados de video con IA, corregí frames a mano en Procreate, edité la pieza final en After Effects y dirigí la música usando herramientas de IA.",
    },
  },
  body: [
    {
      kind: "highlight",
      text: {
        en: "The AI did not create the concept. It became one of the tools I used to reach a visual result I could not have produced alone within the available time, budget and technical constraints.",
        es: "La IA no creó el concepto. Se volvió una de las herramientas que usé para llegar a un resultado visual que no habría podido producir sola con el tiempo, presupuesto y recursos técnicos disponibles.",
      },
    },
    {
      kind: "videoblock",
      ...
      video: {
        youtubeId: "VD1s4Pc72fc",
        poster: {
          kind: "placeholder",
          label: { en: "Portfolio video poster", es: "Portada del portfolio video" },
          tone: "paper",
        },
      },
      caption: {
        ...
        es: "Una pieza audiovisual breve que presenta el concepto detrás de mi portfolio: moverse a través de ideas, procesos y caminos compartidos sin estrellarse contra lo desconocido.",
      },
    },
    {
      kind: "longtext",
      ...
      paragraphs: [
        {
          ...
          es: "El punto de partida no fue técnico. Antes de abrir cualquier herramienta, necesitaba entender qué quería decir. Mi portfolio se construye alrededor de la idea de que cada proceso por el que pasé —diseño, programación, enseñanza, movimiento, música, ciencia y colaboración— moldeó la forma en que trabajo y veo el mundo.",
        },
        {
          en: "I translated that idea into a simple visual script: I climb onto an idea, move through it, let myself fall into the unknown and learn to navigate that fall. Sometimes the process is solitary, sometimes it is shared. But the important part is that I do not crash. I land with delicacy.",
          es: "Traduje esa idea en un guion visual simple: me subo a una idea, la atravieso, me dejo caer hacia lo desconocido y aprendo a navegar esa caída. A veces el proceso es en solitario, a veces es compartido. Lo importante es que no me estrello: aterrizo con delicadeza.",
        },
        {
          ...
          es: "Ese movimiento de caída también tenía sentido para el sitio. Como la landing se experimenta haciendo scroll hacia abajo, el video podía formar parte de ese recorrido vertical y conectar la pieza audiovisual con la propia interacción de la web.",
        },
      ],
    },
    {
      ...
      body: {
        ...
        es: "Quería que el personaje se sintiera ligero, grácil y delicado, casi como una pequeña representación visual de mí misma moviéndome por el proceso. Como la ilustración no es mi fuerte, junté referencias anatómicas de Pinterest, las importé y dibujé encima hasta encontrar una silueta y un gesto que funcionaran. El estilo final tenía que ser lo bastante simple para trabajar con generación de video por IA, y a la vez lo bastante expresivo para sentirse personal.",
      },
      image: {
        kind: "placeholder",
        label: {
      ...
      caption: {
        ...
        es: "El personaje se diseñó a partir de referencia, calco, simplificación e iteración.",
      },
    },
    {
      kind: "decisions",
      ...
      items: [
        {
          ...
          body: {
            en: "The ideas were represented as messy scribbled spheres: dense, tangled and organic, like thoughts that are not fully clear yet but still carry potential.",
        ...
        },
        {
          ...
          body: {
            ...
            es: "Un desafío importante fue dejar suficiente espacio en negativo. El video tenía que mantenerse al centro, mientras que el texto y el layout de la web debían acompañarlo sin saturar el cuadro.",
          },
        },
      ],
    },
      ...
      items: [
        ...
        },
        {
          ...
          body: {
            ...
            es: "Probé Seedream 5, Veo 3 y Kling 3 para generar las transiciones entre frames clave. Seedream fue el que dio los mejores resultados, así que generé varias versiones y probé rápido cómo conectaban entre sí.",
          },
        },
        {
          date: "05",
          ...
          body: {
            ...
            es: "Exporté partes del video como secuencias de imágenes, las llevé a Procreate y borré a mano los artefactos de la IA: brazos de más, cuerpos distorsionados y siluetas rotas.",
          },
        },
        {
          date: "06",
          ...
          body: {
            ...
            es: "Armé la pieza en After Effects, ajusté curvas y zooms, integré videos de proceso, agregué motion blur, usé cámara 3D para dar profundidad, generé esferas de pensamiento adicionales y apliqué el ruido, desenfoque y pulido finales.",
          },
        },
      ],
    },
    {
      ...
      body: {
        ...
        es: "La música tenía que sentirse caprichosa, delicada y aventurera, sin volverse demasiado misteriosa ni dramática. Primero intenté generarla con Lyria, pero los resultados no encajaban con el tono que tenía en mente. Después pasé a Suno e iteré con un prompt detallado que describía el tempo, la instrumentación, la progresión emocional y el cambio exacto que necesitaba en el momento en que el personaje cae.",
      },
      image: {
        kind: "placeholder",
        label: {
      ...
      caption: {
        ...
        es: "La banda sonora final fue generada por IA, pero dirigida con cuidado a partir del clima, el ritmo, la instrumentación y la estructura.",
      },
    },
    {
      kind: "highlight",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        },
        {
          ...
          es: "Aun así, la IA me dio acceso a recursos visuales que habrían sido muy difíciles de producir de otra manera. La usé con cuidado, curando los resultados, descartando lo que no encajaba con el concepto y reparando las partes que rompían el lenguaje visual.",
        },
        {
          ...
          es: "El resultado final tiene sentido para mí porque no es solo un video sobre mi proceso: también es un producto de ese proceso. Requirió concepto, dirección, paciencia, iteración, aprendizaje técnico y cuidado manual.",
        },
      ],
    },
    {
      ...
      image: {
        ...
        label: {
          ...
          es: "07 - portfolio video — visual de cierre",
        },
        tone: "paper",
        src: pv6,
        alt: {
          en: "Portfolio video — closing visual",
          es: "Portfolio video — visual de cierre",
        },
      },
    },
    {
    ...
    },
    {
      ...
      body: {
        en: "This piece became more than a teaser for my portfolio. It became a small reflection of my way of designing: starting from an idea, moving through uncertainty, using whatever tools make sense, asking for help from technology without giving up authorship, and taking care of the details until the result feels honest.",
        es: "Esta pieza se volvió más que un teaser de mi portfolio. Se volvió un pequeño reflejo de mi forma de diseñar: partir de una idea, atravesar la incertidumbre, usar las herramientas que tengan sentido, pedirle ayuda a la tecnología sin renunciar a la autoría y cuidar los detalles hasta que el resultado se sienta honesto.",
      },
    },
  ],
  neighbours: {
