...
export const VALORANT_CHAMPIONS_CASE: CaseData = {
  ...
  tagline: {
    en: "An animated broadcast identity system for Valorant Champions, designed from static graphics to motion pieces.",
    es: "Un sistema de identidad animada para broadcast de Valorant Champions, diseñado desde las piezas estáticas hasta el motion.",
  },
  logo: {
    src: vcLogo,
  ...
  cover: {
    ...
    src: vcCover,
    alt: {
      en: "Valorant Champions — animated brand still",
      es: "Valorant Champions — still de marca animada",
    },
  },
  meta: {
    role: {
  ...
  intro: {
    context: {
      en: "This project was developed for Gráfica para Cine y TV, a course focused on designing graphic systems for audiovisual media. The assignment was to create a full animated brand package from scratch, starting with static identity pieces and later bringing them into motion.",
      es: "Este proyecto se desarrolló para Gráfica para Cine y TV, un curso enfocado en el diseño de sistemas gráficos para medios audiovisuales. La consigna era crear desde cero un paquete de marca animada completo, partiendo de las piezas estáticas de identidad y llevándolas después al motion.",
    },
    problem: {
      en: "Valorant Champions already had a strong visual universe, but its identity changes every year. The challenge was to understand the existing codes of Valorant and Champions, then create a new system that felt believable within the franchise while still having its own visual direction.",
      es: "Valorant Champions ya tenía un universo visual fuerte, pero su identidad cambia cada año. El desafío era entender los códigos existentes de Valorant y de Champions, y luego crear un sistema nuevo que se sintiera creíble dentro de la franquicia y a la vez tuviera su propia dirección visual.",
    },
    goal: {
      en: "Design a complete graphic identity system for Valorant Champions and animate the main pieces as if they belonged to a real esports broadcast package.",
      es: "Diseñar un sistema de identidad gráfica completo para Valorant Champions y animar las piezas principales como si pertenecieran a un paquete de broadcast real de esports.",
    },
    role: {
      ...
      es: "Investigué el lenguaje de marca existente, armé el diagnóstico visual, diseñé el sistema gráfico estático, hice el storyboard del bumper, edité la base musical y animé las piezas finales en After Effects.",
    },
  },
  body: [
    {
      ...
      text: {
        ...
        es: "Este fue el primer proyecto en el que traté el motion no como una capa extra, sino como parte del propio sistema de marca.",
      },
    },
    {
      kind: "videoblock",
      ...
      caption: {
        ...
        es: "Un video de caso que muestra el bumper animado, la gráfica para broadcast y las piezas de motion creadas para la identidad de Valorant Champions.",
      },
    },
    {
      kind: "longtext",
      ...
      paragraphs: [
        {
          en: "The project started with a diagnosis of Valorant and the previous Valorant Champions visual identity. I analysed the game’s graphic language, including its typography, colour palette, glitch-inspired vector style, geometric elements and broadcast compositions.",
        ...
        {
          en: "I also studied the Champions 2021 identity separately, since the event changes its look every year. That edition used a very high-contrast black and white system with gold accents, circular text rings, thin geometric lines, symmetric compositions, large typographic treatments and 3D elements.",
          es: "También estudié la identidad de Champions 2021 por separado, ya que el evento cambia su look cada año. Esa edición usaba un sistema en blanco y negro de muy alto contraste con detalles en dorado, anillos circulares de texto, líneas geométricas finas, composiciones simétricas, tratamientos tipográficos a gran escala y elementos 3D.",
        },
        {
          en: "This research became the foundation for my proposal: a system that would feel connected to both the game and the Champions event, while giving the new identity its own rhythm and hierarchy.",
          es: "Esta investigación se volvió la base de mi propuesta: un sistema que se sintiera conectado tanto con el juego como con el evento Champions, dándole a la nueva identidad su propio ritmo y jerarquía.",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          body: {
            en: "I integrated the red and glitch language of Valorant with the black, white and gold contrast of Champions, creating a bridge between the game and the tournament.",
            es: "Integré el lenguaje rojo y glitch de Valorant con el contraste en blanco, negro y dorado de Champions, creando un puente entre el juego y el torneo.",
          },
        },
        {
          n: "02",
          ...
          body: {
            en: "Typography became more than information. Repeated words, rings of text and large-scale type helped build rhythm, hierarchy and motion opportunities.",
        ...
        },
        {
          ...
          body: {
            ...
            es: "El sistema estático se creó pensando en la animación: anillos, grillas, fragmentos del logo, cortes y formas geométricas podían escalarse, rotar, glitchear y sincronizarse con el beat.",
          },
        },
      ],
    },
    ...
    },
    {
      ...
      body: {
        en: "Before animating, I designed the main static pieces of the broadcast package: waiting screen, transitions, score elements, support grids, round win graphics, lower thirds, replay frame and caster camera graphics. This helped me understand the system as a full audiovisual identity rather than a single bumper.",
        es: "Antes de animar, diseñé las principales piezas estáticas del paquete de broadcast: pantalla de espera, transiciones, elementos de marcador, grillas de apoyo, gráficas de victoria de ronda, lower thirds, frame de replay y gráficas de la cámara de casters. Eso me ayudó a entender el sistema como una identidad audiovisual completa y no solo como un bumper aislado.",
      },
      image: {
        kind: "placeholder",
        label: {
      ...
      items: [
        {
          ...
          body: {
            ...
            es: "Investigué la identidad actual de Valorant y la edición anterior de Champions, identificando elementos recurrentes: paletas, tipografías, efectos glitch, líneas geométricas y layouts de broadcast.",
          },
        },
        {
          date: "02",
          ...
          body: {
            ...
            es: "Armé un moodboard para definir la atmósfera del nuevo sistema, combinando la intensidad del esports, el alto contraste, los detalles dorados, los acentos rojos y composiciones tipográficas por capas.",
          },
        },
        {
          date: "03",
          ...
          body: {
            ...
            es: "Diseñé las principales piezas de broadcast como composiciones fijas, incluyendo pantallas, transiciones, elementos de marcador, grillas de apoyo y frames de replay.",
          },
        },
        {
          date: "04",
          ...
          body: {
            ...
            es: "La música se creó primero editando un track existente de Champions en Reaper, para que el motion pudiera sincronizarse después con el beat.",
          },
        },
        {
          date: "05",
          ...
          body: {
            ...
            es: "Planifiqué el bumper frame por frame, definiendo cuándo los elementos iban a escalarse, cortar, moverse de costado, glitchear o revelar el logo en sincronía con la música.",
          },
        },
        {
          date: "06",
          ...
          body: {
            ...
            es: "Animé las piezas en After Effects, trabajando con cambios de escala, timing de movimiento, glitches del logo, transiciones, tipografía por capas y movimiento al estilo broadcast.",
          },
        },
      ],
    },
    {
      ...
      text: {
        ...
        es: "Diseñar para el motion me hizo entender que una marca puede tener ritmo, no solo forma.",
      },
    },
    {
      kind: "longtext",
      ...
      paragraphs: [
        {
          en: "This was the first time I worked this extensively with After Effects. Until then, I had approached motion more as isolated animation exercises. In this project, every movement had to serve a larger graphic identity.",
          es: "Fue la primera vez que trabajé tan a fondo con After Effects. Hasta ese momento, había abordado el motion más como ejercicios de animación aislados. En este proyecto, cada movimiento tenía que servir a una identidad gráfica más amplia.",
        },
        {
          ...
          es: "El mayor desafío fue traducir composiciones estáticas a motion sin perder consistencia. Los elementos tenían que sentirse enérgicos y competitivos, pero a la vez lo bastante controlados como para funcionar dentro de un sistema de broadcast.",
        },
        {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          es: "Este proyecto me empujó a sentirme más cómoda con After Effects y a entender el motion como un lenguaje de diseño.",
        },
      ],
    },
    {
      ...
      title: {
        ...
        es: "De la identidad estática al sistema en motion",
      },
      body: {
        en: "This project helped me understand animated branding as a full system. The final result was not only a set of moving graphics, but a visual language with rules, rhythm and behaviour. It was an important step in learning how to design for screens where identity, information and movement need to work together.",
        es: "Este proyecto me ayudó a entender el branding animado como un sistema completo. El resultado final no fue solo un conjunto de gráficas en movimiento, sino un lenguaje visual con reglas, ritmo y comportamiento. Fue un paso importante para aprender a diseñar para pantallas donde la identidad, la información y el movimiento tienen que funcionar juntos.",
      },
    },
  ],
  neighbours: {
